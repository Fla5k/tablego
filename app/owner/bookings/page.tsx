...
export default function OwnerBookingsPage() {
  ...
  const fetchOwnerUser = useCallback(async () => {
  ...
  const fetchBookings = useCallback(async () => {
    ...
    console.log("OWNER BOOKING RESPONSE:", data);
  ...
  const loadData = useCallback(
    async (isRefresh = false) => {
      try {
        ...
        const ownerUser = await fetchOwnerUser();
  ...
  const handleUpdateStatus = async (
    ...
    try {
      ...
      console.log("OWNER UPDATE BOOKING RESPONSE:", data);
        ...
        <div className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-gray-600">
              Pantau dan proses booking seluruh restoran berdasarkan tanggal.
            </p>
